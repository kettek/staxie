...
<ModalBody>
  <RadioButtonGroup legendText="Color Mode" name="colorMode" selected={indexed ? 'indexed' : 'truecolor'}>
...
<ModalFooter primaryButtonText="Apply" secondaryButtonText="Cancel" on:click:button--secondary={() => (open = false)} />
