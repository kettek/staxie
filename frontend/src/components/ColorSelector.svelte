...
<style>
  ...
  .hsv_saturation {
    ...
    width: 100%;
    height: 100%;
    background-image: linear-gradient(to right, rgba(255, 255, 255, 255) 0%, rgba(255, 255, 255, 0) 100%);
  }
  .hsv_value {
    position: absolute;
    top: 0;
  ...
  .hue {
    background-image: linear-gradient(to left, #ff0000, #ff0080, #ff00ff, #8000ff, #0000ff, #0080ff, #00ffff, #00ff80, #00ff00, #80ff00, #ffff00, #ff8000, #ff0000);
  }
  .alpha {
    z-index: 0;
  }
